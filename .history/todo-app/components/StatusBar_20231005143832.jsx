    ...
    <Box fontWeight={"700"} color={"grey"}>
        {isMobileView ? (<Flex direction={"column"}>
            ...
            <Box mt="3em" h="3em" minW={"100%"} backgroundColor={colorMode === "light" ? "hsl(0,0%,98%)" : "hsl(235,21%,11%)"}>
                ...
                <Text onClick={handleActiveClick} cursor={"pointer"} active={{color: "hsl(220, 98%, 61%)"}} _hover={{color: colorMode === "light" ? "black" : "white"}}>
                    Active
                </Text>
                ...
                <Text onClick={handleAllClick} _active={{color: "hsl(220, 98%, 61%)"}}  cursor={"pointer"} _hover={{color: colorMode === "light" ? "black" : "white"}}>
                    All
                </Text>
