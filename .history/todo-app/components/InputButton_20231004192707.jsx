...
export const InputButton = ({colorMode, todo}) => {
  return (
    <Flex m="2.5em 0" background={colorMode === "light" ? "white" : "#1a202c"} p="2" borderRadius={"0.5em"}>
        <InputGroup>
         ...
         <Input fontWeight={"700"} fontSize={"1.2em"} type="text" h="3em" variant={"unstyled"} placeholder="Enter your todo here..." ml={".5em"} value={todo} onChange={(e)}/>
        </InputGroup>
    </Flex>
  )
}
