...
const lightBG = () => {
-  //TODO: Add code that changes the background size to either desktop image or mobile image based on screen size
+  const desktopImage = 'desktop-image.jpg';
+  const mobileImage = 'mobile-image.jpg';
+  const screenSize = window.innerWidth;
+
+  const backgroundImage = screenSize > 768 ? desktopImage : mobileImage;
+  document.body.style.backgroundImage = `url(${backgroundImage})`;
}
<<<<<  bot-257237bd-5e7e-4e7c-b549-197c1462d56b  >>>>>
