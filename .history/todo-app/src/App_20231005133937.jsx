...
const lightBG = () => {
-  //TODO: Change background image size based on small or large screen size
+  // Set the desktop and mobile image paths
  const desktopImage = lightBackgroundImage;
  const mobileImage = mobileLightImage;
+
+  // Check if the screen size is greater than 578 pixels
  const screenSize = window.innerWidth > 578;

+  // Determine the background image based on the screen size
  const backgroundImage = screenSize ? mobileImage : desktopImage;
-  
+
+  // Set the background image properties of the body element
  const bodyStyle = document.body.style;
  bodyStyle.backgroundImage = `url(${backgroundImage})`;
  bodyStyle.backgroundRepeat = 'no-repeat';
  bodyStyle.backgroundSize = 'cover';
}
<<<<<  bot-980c7c7a-b00b-4290-8d57-ba55c904a9d9  >>>>>
...
const darkBG = () => {
  ...
  const backgroundImage = screenSize > 375 ? desktopImage : mobileImage;
