...
const lightBG = () => {
  //TODO: Toggle between desktop image and mobile image based on desktop size
  const desktopImage = lightBackgroundImage;
  const mobileImage = mobileLightImage;
  const screenSize = window.screen.width >= 350;
...
const darkBG = () => {
  ...
  const screenSize = window.screen.width >= 1440;

  const backgroundImage = screenSize ? desktopImage : mobileImage;
